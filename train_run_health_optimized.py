#!/usr/bin/env python3
"""
Training script for humanoid running task with optimized health reward.

This script uses higher health reward weight to encourage the robot
to stay upright longer, reducing the frequency of falls.
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description='Train humanoid running policy with optimized health reward'
    )
    ...
    parser.add_argument(
        ...
        help='Healthy reward weight (default: 3.0, increased from 1.0)'
    )
    ...
    parser.add_argument(
        ...
        help='Fall penalty (default: 100.0, increased from 50.0)'
    )
...
def main():
    ...
    run_name = f"ppo_mujoco_run_health_opt_{timestamp}"
    
    print("=" * 70)
    print("Humanoid Running Training with Health Optimization")
    print("=" * 70)
    ...
    print(f"  Healthy reward: {args.healthy_reward} (increased from 1.0)")
    ...
    print(f"  Fall penalty: {args.fall_penalty} (increased from 50.0)")
    print("=" * 70)
